 ...
 */
    ...
    (() => {
        ...
        /* harmony default export */ const fileUploadForm = function(_super) {
            ...
            return __extends(FileUploadForm, _super), FileUploadForm.prototype.render = function() {
                return react.createElement("div", {
                    ...
                    name: "excelFile",
                    type: "file",
                    className: "text-gray-500 border border-gray-200 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-sky-500 file:text-white hover:file:bg-sky-700"
                })), react.createElement("div", {
                    className: "m-3"
                }, react.createElement("input", {
                    type: "submit",
        ...
        /* harmony default export */ const removeUploadForm = function(_super) {
            function RemoveUploadForm(props) {
                ...
                return _this.state = {
                    ...
                    e.preventDefault(), _this.setState({
                        loading: !0,
                        racesLoading: !0
                    }), google.script.run.withSuccessHandler(_this.setRaceNames).withFailureHandler(_this.handleFailure).removeRaceHandler(document.getElementById("removeForm"));
                }, _this;
            }
        ...
        /* harmony default export */ const root = function(_super) {
            ...
            return root_extends(Root, _super), Root.prototype.setActiveTab = function(tabName) {
                ...
                return react.createElement("div", {
                    ...
                    className: "bg-white inline-block py-2 px-4 font-semibold ".concat("dangerForm" === this.state.activeTabName ? "border-l border-t border-r rounded-t text-blue-700" : "text-gray-400 hover:text-blue-300"),
                    href: "#",
                    onClick: function() {
                        return _this.setActiveTab("dangerForm");
                    }
                }, "Tab")))), react.createElement("div", {
                    className: "h-full m-10 flex flex-col text-center"
