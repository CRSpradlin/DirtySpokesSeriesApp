        ...
        /* harmony default export */ const fileUploadForm = function(_super) {
            ...
            return __extends(FileUploadForm, _super), FileUploadForm.prototype.render = function() {
                return react.createElement("div", {
                    ...
                    name: "excelFile",
                    type: "file",
                    className: "text-gray-500 border w-[35rem] border-gray-200 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-sky-500 file:text-white hover:file:bg-sky-700"
                })), react.createElement("div", {
                    className: "m-3"
                }, react.createElement("input", {
                    type: "submit",
